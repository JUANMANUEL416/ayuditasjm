...
--
	CREATE TABLE #FTRD1(CNSFTR VARCHAR(40), N_CUOTA	int IDENTITY, FECHA datetime,
				...
				SELECT '9900000306', GETDATE(), 'DB', AUT.IDAREA, NULL, 
						AUTD.VALORCOPAGO, 
						...
						AUTD.VALORCOPAGO,0, 
						0, AUT.IDPROVEEDOR, '0100003891',AUTD.IDAUT, AUTD.NO_ITEM, NULL, 
						'B004-00000275', AUT.SUBCCOSTO, AUTD.VALORTOTALCOSTO,AUT.FECHA, AUT.IDPLAN,
         ...
         WHERE 1=1
			...
			SELECT '9900000306', N_CUOTA, FECHA, DB_CR, AREAPRESTACION, UBICACION
               ,VR_TOTAL
               ,IMPUTACION ,CCOSTO, PREFIJO, ANEXO, REFERENCIA, IDCIRUGIA,CASE WHEN COALESCE(CANTIDAD,0)<=0 THEN 1 ELSE CANTIDAD END
               ,VALOR,VLR_SERVICI, VLR_COPAGOS, VLR_PAGCOMP, IDPROVEEDOR, NOADMISION
               ,NOPRESTACION, NOITEM, AREAFUNCONT, 'B004-00000275', SUBCCOSTO, PCOSTO, FECHAPREST
               ,IDIMPUESTO, IDCLASE,ITEM , VLRIMPUESTO, PIVA, VIVA,CUENTA_FIMPDV        
			FROM   #FTRD1
         ...
         DECLARE @MIVA BIT
         DECLARE @NVOCONSEC VARCHAR(20)='B004-00000275'
