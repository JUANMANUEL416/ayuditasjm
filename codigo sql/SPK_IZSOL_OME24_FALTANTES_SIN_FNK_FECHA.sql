IF EXISTS(SELECT NAME FROM SYSOBJECTS WHERE NAME='SPK_IZSOL_OME24_FALTANTES_SIN_FNK_FECHA' AND XTYPE='P')
BEGIN
   DROP PROCEDURE SPK_IZSOL_OME24_FALTANTES_SIN_FNK_FECHA
END
GO
CREATE PROC DBO.SPK_IZSOL_OME24_FALTANTES_SIN_FNK_FECHA
      ...
      BEGIN 
         ...
         BEGIN
            ...
            BEGIN   --'DESPUES DE 7'
               ...
               IF (SELECT COUNT(*) FROM HBALI WHERE NOADMISION = @NOADMISION AND CONVERT(VARCHAR,FECHA,104) = CONVERT(DATETIME,CONVERT(VARCHAR,@FECHAULT,104)))= 0
               BEGIN                        
