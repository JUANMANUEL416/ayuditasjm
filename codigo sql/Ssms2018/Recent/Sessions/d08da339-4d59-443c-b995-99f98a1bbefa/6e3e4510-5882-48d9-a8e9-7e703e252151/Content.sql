...
BEGIN
	...
	BEGIN
		...
		SELECT @NROCONTRATO=COALESCE(CNT.IDALTERNA,PPT.NROCONTRATO)
			-- https://web.sispro.gov.co/WebPublico/Consultas/ConsultarDetalleReferenciaBasica.aspx?Code=modalidadPago
			, @MODALIDAD_CNT=IIF(COALESCE(MODALIDAD, '')<>'',MODALIDAD,
				CASE COALESCE(CAPITADO, 0) 
					WHEN 1 THEN '03' -- Pago po capitacion 
					WHEN 0 THEN
	...
	BEGIN 
		...
		BEGIN -- Datos correspondiente al usuario (Paciente y Usuario de la factura)
			...
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Value>'+LEFT(COALESCE(@CODHABILITA, ''),20)+'</Value>'  --STORRES
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'</AdditionalInformation>' 
			...
			DECLARE @CobertuPlanBeneficio VARCHAR(200)
			...
			--BEGIN
				...
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Value>'+COALESCE(@NOPOLIZA,dbo.FNK_LIMPIATEXTO(@IDPLAN, 'A-Z0-9'),'')+'</Value>' 
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'</AdditionalInformation>' 
			--END
		...
		BEGIN -- URL para descarga de archivos
			SET @XML+=@E+@T+@T+@T+@T+@T+'<Interoperabilidad>' 
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+'<InteroperabilidadPT>' 
			-- URL para la descargar de los documentos complementarios a los documentos e instrumentos electrónicos
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+'<URLDescargaAdjuntos>' 
			-- TODO >> Desarrollar para alojar los archivos que corresponden a los anexos de la factura
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'<URL></URL>' 
			BEGIN -- Información adicional, claves, nombre de archivos o características. 
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'<ParametrosArgumentos>'
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<ParametroArgumento>'
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Name></Name>'
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Value></Value>'
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'</ParametroArgumento>'
				SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'</ParametrosArgumentos>'
			END
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+'</URLDescargaAdjuntos>'
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+'<EntregaDocumento>'
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'<ParametrosArgumentos>'
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<ParametroArgumento>'
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Name></Name>'
			SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Value></Value>'
...
--Query2
	...
	BEGIN -- Total de la Factura
		...
		SET @XML+=@E+@T+@T+'<cbc:PayableAmount currencyID="'+COALESCE(@IDMONEDA,'COP')+'">'+CAST(@VR_FACTURA - COALESCE(@DESCUENTO, 0) - IIF(@COPAGOIPS=1,@VALORCOPAGO,0) + IIF(@BASE_IVA_SERVICIOS='CONIVA', 0, COALESCE(@VR_IVA,0)) AS VARCHAR)+'</cbc:PayableAmount>' -- Valor final a pagar, valor factura  + impuestos - descuentos - anticipos
		SET @XML+=@E+@T+'</cac:LegalMonetaryTotal>'
	END
	...
	BEGIN -- Detalles de la Factura
		...
		-- Si hay descuento en FTR se debe convertir en porcentaje y aplicar el prorrateo en los detalles FTRD
		...
		BEGIN
			...
			, @ANEXO=DBO.FNK_LIMPIATEXTO(ANEXO,'0-9 A-Z();:.,')
			,@CANTIDAD=CANTIDAD
			,@VALOR=VALOR, @VLR_SERVICI=VLR_SERVICI, @REFERENCIA=REFERENCIA 
		...
		BEGIN
         ...
         , @REFERENCIA=IDSERVICIO 
			...
			BEGIN
				...
				--SET @XML+=@E+@T+@T+@T+@T+'<cbc:TaxableAmount currencyID="'+COALESCE(@IDMONEDA,'COP')+'">'+IIF(@VR_IVA>0, CAST(@VLR_SERVICI AS VARCHAR), '0.00')+'</cbc:TaxableAmount>' -- Monto Imponible 
