...
EXEC SPQ_JSON '{"MODELO":"FTR_IMPRESION","METODO":"DATOSFTR","PARAMETROS":{"N_FACTURA":"F002-00000098"},"USUARIO":"JJIMENEZ"}'

UPDATE FTR SET IDFORMATO='PE03' WHERE PROCEDENCIA='SALUD'


EXEC SPK_GENERA_JSON_PERU_FTR_INTEGRA 'F002-00000093'
         ...
         SELECT ITEM=CONVERT(varchar(3),N_CUOTA),CANTIDAD=CONVERT(varchar(4),CONVERT(INT,CEILING(FTRD.CANTIDAD))),
                ...
                VALOR3=CONVERT(VARCHAR(20),CONVERT(DECIMAL(14,2),ROUND(CASE WHEN COALESCE(VIVA,0)>0 THEN COALESCE(VLRIMPUESTO,FTRD.VALOR*FTRD.CANTIDAD,0)+VIVA ELSE VLR_SERVICI END,2))),
                ...
                VALOR7=CONVERT(VARCHAR(20),CONVERT(DECIMAL(14,2),CASE WHEN COALESCE(VIVA,0)>0 THEN COALESCE(VLRIMPUESTO,FTRD.VALOR*FTRD.CANTIDAD,0) ELSE VALOR END)),
				    ANEXO= dbo.FNK_LIMPIATEXTO(CASE WHEN 'FINANCIERO'='FINANCIERO' THEN FTRD.ANEXO ELSE CASE WHEN COALESCE(SER.DESCRIPCION_CUPS,'')='' THEN SER.DESCSERVICIO ELSE SER.DESCRIPCION_CUPS END END,'0-9 A-Z'), 
