SELECT PRE.NOM_PREFIJO, CIT.CONSECUTIVO, AUT.IDAUT,CONVERT(VARCHAR,AUT.FECHA,103)FECHA,CONVERT(VARCHAR,AUT.FECHA,108)HORA,  
AFI.NOMBREAFI [PACIENTE], AFI.TIPO_DOC [TIPO DOCUMENTO], AFI.DOCIDAFILIADO [DOCUMENTO], 
AFI.FNACIMIENTO [F. NACIMIENTO], AFI.EDAD , AFI.EMAIL, AFI.CELULAR, 
MED.NOMBRE [MEDICO], MES.DESCRIPCION [ESPECIALIDAD], PLN.DESCPLAN [PLAN], AFI.DIRECCION , 
TGEN.DESCRIPCION [DISTRITO], SER.DESCSERVICIO [EXAMEN]
...
AND CONVERT(DATE,AUT.FECHA)>= @1FINI AND CONVERT(DATE,AUT.FECHA)<= @2FFIN
