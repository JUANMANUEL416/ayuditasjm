IF EXISTS(SELECT NAME FROM SYSOBJECTS WHERE NAME='SPK_IZSOL_OME24_FALTANTES' AND XTYPE='P')
BEGIN
   DROP PROCEDURE SPK_IZSOL_OME24_FALTANTES
END
GO
CREATE PROC DBO.SPK_IZSOL_OME24_FALTANTES
