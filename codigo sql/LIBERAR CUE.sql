ALTER TABLE [dbo].[FPA]     CHECK CONSTRAINT [FK_FPA_FPACUENTA]
ALTER TABLE [dbo].[PAR]     CHECK CONSTRAINT [FK_PAR_PARCTACRUCECAJA]
ALTER TABLE [dbo].[OFIN]    CHECK CONSTRAINT [FK_OFIN_OFINCUENTA]
ALTER TABLE [dbo].[TTEC]    CHECK CONSTRAINT [FK_TTEC_TTECCUENTA]
ALTER TABLE [dbo].[FTRCXC]  CHECK CONSTRAINT [FK_FTRCXC_FTRCXCCUENTA]
ALTER TABLE [dbo].[FNT]     CHECK CONSTRAINT [FK_FNT_FNTCUENTA]
ALTER TABLE [dbo].[KPRES]   CHECK CONSTRAINT [FK_KPRES_KPRESCUENTA_PER]
ALTER TABLE [dbo].[KPRES]   CHECK CONSTRAINT [FK_KPRES_KPRESCUENTA_UTI]
ALTER TABLE [dbo].[FDISD]   CHECK CONSTRAINT [FK_FDISD_FDISDCUENTA]
