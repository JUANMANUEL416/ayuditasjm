/**************************************************************************************************/
IF EXISTS (SELECT name FROM sysobjects WHERE name = 'SPKJ_FECHA_TARIFAS' AND type = 'P')
   DROP PROCEDURE SPKJ_FECHA_TARIFAS
GO
/**************************************************************************************************/
CREATE PROC DBO.SPKJ_FECHA_TARIFAS
AS
...
BEGIN
   ...
   SELECT @FECHAULT = DBO.FNK_VALORVARIABLE('FECHA_CAMBIO_TARIFAS')
   --SELECT @FECHAULT
   ...
   BEGIN               
      ...
      IF @VECES = 0
      BEGIN
         UPDATE TARF SET FECHAFIN = @FECHAULT   --FECHAFIN + 365   
